---
title: Testiranje alhemiji umetnutim slikama
ms.author: pebaum
author: pebaum
ms.date: 04/21/2020
ms.audience: ITPro
...
---
# <a name="access-the-domains-page"></a><span data-ttu-id="84083-102">Pristup stranici "domeni"</span><span class="sxs-lookup"><span data-stu-id="84083-102">Access the Domains Page</span></span>

<span data-ttu-id="84083-103">Da biste pristupili stranici domeni, samo kliknite na ovu ikonu ispod:</span><span class="sxs-lookup"><span data-stu-id="84083-103">To access the domains page, just click this icon below:</span></span>
...
<span data-ttu-id="84083-104">Zatim možete da dodate, izmenite ili uklonite domen.</span><span class="sxs-lookup"><span data-stu-id="84083-104">Then you can add, modify, or remove your domain.</span></span>
<span data-ttu-id="84083-105">Više informacija potražite u članku [najčešća pitanja o domenima.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span><span class="sxs-lookup"><span data-stu-id="84083-105">For more information, see the [Domains FAQ.](https://docs.microsoft.com/microsoft-365/admin/setup/domains-faq)</span></span>
