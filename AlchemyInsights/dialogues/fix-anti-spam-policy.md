...
---
# <a name="fix-anti-spam-policy"></a>Rešavanje smernica za borbu protiv bezvredne pošte
...
3. Razvijte opciju **Svojstva bezvredne pošte** i Pregledajte postavke **oznake kao bezvredne** .
